<template>
    <v-container>
        ...
        <div class="panel">
            ...
            <PaymentView @search="search" style="margin-bottom: 10px; background-color: #ffffff;"></PaymentView>
                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="Item">{{ val.item }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <String label="Item" v-model="selectedRow.item" :editMode="true"/>
